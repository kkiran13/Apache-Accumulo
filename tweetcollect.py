...
#teamarray = ['Celtics','Knicks','76ers','Nets','Raptors','Bulls','Pacers','Bucks','Pistons','Cavs','MiamiHeat','OrlandoMagic','Hawks','Bobcats','Wizards','okcthunder','Nuggets','TrailBlazers','UtahJazz','TWolves','Lakers','Suns','GSWarriors','Clippers','NBAKings','GoSpursGo','Mavs','Hornets','Grizzlies','Rockets']
teamarray = ['GoSpursGo']
i=0
for i in range(0,len(teamarray)):
    hashtag = teamarray[i] ##### this line need to change
    delimiter = ','
